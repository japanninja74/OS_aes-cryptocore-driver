...
HD_PWD='/home/riccardo/git/aes-cryptocore/hw_platform_300923/hw_platform/hw_platform.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_platform_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw_platform_wrapper.tcl -notrace
